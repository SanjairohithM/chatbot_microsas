# OmniX Smart Sync WordPress Plugin
...
1. Download the `omnix-smart-sync` folder
...
- **OmniX Platform URL**: Your OmniX platform URL (default: https://72d0939e1715.ngrok-free.app )

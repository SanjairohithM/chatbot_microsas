...
class OmniX_Smart_Sync {
    ...
    public function __construct() {
        $this->api_base_url = get_option('omnix_smart_sync_api_url', ' https://e282694e5c26.ngrok-free.app');
    ...
    public function activate() {
        // Set default options
        add_option('omnix_smart_sync_api_url', 'https://e282694e5c26.ngrok-free.app');
    ...
    public function settings_page() {
        ...
        $api_url = get_option('omnix_smart_sync_api_url', ' https://e282694e5c26.ngrok-free.app');
